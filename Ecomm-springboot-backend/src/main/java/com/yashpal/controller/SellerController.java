package com.yashpal.controller;

import com.yashpal.config.JwtProvider;
import com.yashpal.domain.AccountStatus;
import com.yashpal.domain.USER_ROLE;
...
import com.yashpal.repository.VerificationCodeRepository;
import com.yashpal.response.ApiResponse;
import com.yashpal.response.AuthResponse;
import com.yashpal.service.*;
import com.yashpal.service.impl.CustomeUserServiceImplementation;
import com.yashpal.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Shopzy Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Shopzy Email Verification Code";
        String text = "Welcome to Shopzy, verify your account using this link ";
